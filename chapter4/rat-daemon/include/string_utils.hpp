...
namespace s9 {
  ...
  static inline std::string DateTimeStamp() {
  ...
  */
  ...
  static inline std::vector<std::string> SplitStringChars(std::string& input, const std::string& delimiters) {
    size_t current;
    size_t next = -1;
  ...
  static inline std::vector<std::string> SplitStringWhitespace(std::string& input ) { 
    size_t start = 0;
    size_t end = 0;
    std::vector<std::string> tokens;
